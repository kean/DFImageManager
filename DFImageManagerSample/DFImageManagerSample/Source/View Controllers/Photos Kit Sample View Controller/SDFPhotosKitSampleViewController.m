...
- (void)_configureImageManager {
    ...
    [factory registerImageManager:imageManager forAssetClass:[PHAsset class]];
    [factory registerImageManager:imageManager forAssetClass:[DFPHAssetlocalIdentifier class]];
