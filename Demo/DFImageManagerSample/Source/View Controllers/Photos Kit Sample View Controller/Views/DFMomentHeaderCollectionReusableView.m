...
@interface DFMomentHeaderCollectionReusableView ()

@property (weak, nonatomic) UIVisualEffectView *visualEffectView;

@end

@implementation DFMomentHeaderCollectionReusableView
...
- (IBAction)buttomSelectPressed:(UIButton *)sender {
    [self.delegate momentHeader:self didPressButton:sender];
}
